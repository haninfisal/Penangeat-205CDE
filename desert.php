...
<!------------------------------------------------------------------ Jumbo Header ------------------------------------------------------------------------------------------->
	...
	<div class="jumbotron jumbotron-fluid bg-cover text-white" style="background-image: linear-gradient(to bottom, rgba(0,0,0,0.6) 0%,rgba(0,0,0,0.6) 100%), url(ice.jpg)">
		<div class="container">
	...
	<h2 class="text-center" style="font-family: Hervatica; opacity: 0.6;">Penang Best Deserts</h2>
		<hr>
	  ...
	  <div class="row">
		...
		<div class="col-md-4 mt-5">
		  <div class="card text-center">
			<img class="card-img-top" style="height: 200px;" src="ais.jpg" alt="Card image cap">
			<div class="card-body" id="card">
			  <h5 class="card-title">Lily Penang Hill Ice Kacang</h5>
			</div>
			<div class="card-footer text-muted">
			  <div class="row">
				<div class="col">
				  <a href="https://goo.gl/maps/uqXUzhbiKPswRA3J7"><i class="fas fa-map" data-toggle="tooltip" data-placement="top" title="View Location" ></i></a>
				</div>
				<div class="col">
		...
		<div class="col-md-4 mt-5">
		  <div class="card text-center">
			<img class="card-img-top" style="height: 200px;" src="slice.jpg" alt="Card image cap">
			<div class="card-body" id="card">
			  <h5 class="card-title">Cakes At China House</h5>
			</div>
			<div class="card-footer text-muted">
			  <div class="row">
				<div class="col">
				  <a href="https://goo.gl/maps/2Hk9TiABcqyruFba9"><i class="fas fa-map" data-toggle="tooltip" data-placement="top" title="View Location" ></i></a>
				</div>
				<div class="col">
	  ...
	  <div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<center>Lily Penang Hill</center>
			<center>+60164070304<center>
		  </div>
	...
	<div class="modal fade" id="Modal2" tabindex="-1" role="dialog" aria-labelledby="ModalTitle" aria-hidden="true">
	  <div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<center>China House</center>
			<center>+6042637299<center>
		  </div>
		  <div class="modal-footer">
			<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
		  </div>
